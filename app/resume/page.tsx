      ...
      <section className="relative pb-12">
        <div className="relative mx-auto max-w-6xl px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            <Button asChild size="default" className="h-12 px-6 rounded-xl gap-2 shadow-lg shadow-primary/25 w-full sm:w-auto">
              <Link href="/resume">
          ...
          <div className="p-8 sm:p-12 border-b border-border/30 bg-gradient-to-br from-primary/20 via-primary/10 to-transparent">
            ...
            <div className="space-y-8">
              {experience.map((job, index) => (
                <div key={index} className="relative pl-8 border-l-2 border-primary/40">
